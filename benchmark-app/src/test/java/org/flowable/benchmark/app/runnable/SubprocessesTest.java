...
class SubprocessesTest extends BaseTest {

    @Test
    @Deployment(resources = "benchmark-processes/parallelSubprocesses.bpmn20.xml")
    public void testProcess() {
        assertThat(historyService.createHistoricProcessInstanceQuery().count()).isZero();

        SubprocessesRunnable runnable = new SubprocessesRunnable(runtimeService, taskService);
